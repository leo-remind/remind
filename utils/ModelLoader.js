...
//         { name: 'ssd_mobilenetv1_model-shard1', module: require('@/assets/models/ssd_mobilenetv1_model-shard1') },
//         { name: 'face_recognition_model-weights_manifest.json', module: faceModelManifest },
//         { name: 'face_recognition_model-shard1', module: require('@/assets/models/face_recognition_model-shard1') }
//       ];
