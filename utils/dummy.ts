...
export async function insertDummyConversations(db: SQLiteDatabase) {
    ...
    const dummyConversations = [
        ...
        { summary: "A debate on the ethical considerations surrounding the use of AI in healthcare, including issues related to data privacy, algorithmic bias, and the role of AI in diagnostics and treatment planning.", transcript_start: "2025-02-02 15:00:00", transcript_end: "2025-02-02 15:45:00", location_id: 2 },
        ...
        { summary: "Discussion on reinforcement learning techniques, including deep Q-networks and policy gradient methods, with a focus on real-world applications such as robotics and game playing.", transcript_start: "2025-02-04 09:00:00", transcript_end: "2025-02-04 09:45:00",  location_id: 1 },
